...
print("loaded dataset", train_ds)
print("cardinatlity", int(train_ds.cardinality()))
...
validation_ds = validation_ds.skip((val_batches // 3)*2)
...
outputs = tf.keras.layers.Dense(38)(x)  # 38 units for classifying
